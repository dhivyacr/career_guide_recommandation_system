...
function buildFallbackAnswer(question, context) {
  ...
  if (normalizedQuestion.includes("resume") || normalizedQuestion.includes("interview")) {
    return `Center your resume on ${bestCareer} with quantified project bullets, then prepare interview stories around ${formatList(matchedSkills) || "your strongest skills"}.`;
  }
  ...
  const [messages, setMessages] = useState([
    {
      id: "welcome",
      sender: "ai",
      text: "Ask about careers, missing skills, projects, or interview prep. I’ll answer using your current recommendation profile."
    }
  ]);
